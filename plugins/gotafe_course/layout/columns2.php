...
$html = theme_gotafe_course_get_html_for_settings($OUTPUT, $PAGE);
...
<div id="page" class="container-fluid">
    ...
    <header id="page-header" class="clearfix">
        <a class="logo" href="<?php echo $CFG->wwwroot; ?>" title="<?php print_string('home'); ?>" alt="<?php print_string('home'); ?>"><span class="text">Home</span></a>
