...
function theme_gotafe_hr_process_css($css, $theme) {

    /****************************
    Set Logo as background image
    *****************************/
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_gotafe_hr_set_logo($css, $logo);
    ...
    $css = theme_gotafe_hr_set_customcss($css, $customcss);
	...
	//        $favicon = null;
	//    }
	// $css = theme_gotafe_hr_set_favicon($css, $favicon);
    ...
    *****************************/
    ...
    $css = gotafe_hr_set_backgroundcolor($css, $backgroundcolor);
    ...
    *****************************/
    ...
    $css = gotafe_hr_set_headerbgcolor($css, $headerbgcolor);
    ...
    *******************************************/
    ...
    $css = gotafe_hr_set_pagenavbgcolor($css, $pagenavbgcolor);
    ...
    *****************************/
    ...
    $css = gotafe_hr_set_blockheadertextcolor($css, $blockheadertextcolor);
    ...
    $css = gotafe_hr_set_blockheaderbgcolor($css, $blockheaderbgcolor);
	*/
    ...
    $css = gotafe_hr_set_blockbgcolor($css, $blockbgcolor);
    ...
    ***************************/
    ...
    $css = gotafe_hr_set_primarydarkcolor($css, $primarydarkcolor);
    ...
    ***************************/
    ...
    $css = gotafe_hr_set_primarylightcolor($css, $primarylightcolor);

    return $css;
}


function theme_gotafe_hr_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
    if (is_null($replacement)) {
        $replacement = $OUTPUT->pix_url('logo','theme');
        //$replacement = 'gotafe_hr/pix/logo.png';
    }
 ...
 * @return bool
 */
function theme_gotafe_hr_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'logo') {
        $theme = theme_config::load('gotafe_hr');
...
function gotafe_hr_set_backgroundcolor($css, $backgroundcolor) {
...
function gotafe_hr_set_blockheadertextcolor($css, $blockheadertextcolor) {
...
function gotafe_hr_set_headerbgcolor($css, $headerbgcolor) {
...
/*
function gotafe_hr_set_blockheaderbgcolor($css, $blockheaderbgcolor) {
...
function gotafe_hr_set_blockbgcolor($css, $blockbgcolor) {
...
function gotafe_hr_set_pagenavbgcolor($css, $pagenavbgcolor) {
...
function gotafe_hr_set_primarydarkcolor($css, $primarydarkcolor) {
...
function gotafe_hr_set_primarylightcolor($css, $primarylightcolor) {
...
function theme_gotafe_hr_set_customcss($css, $customcss) {
 ...
 */
function theme_gotafe_hr_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
